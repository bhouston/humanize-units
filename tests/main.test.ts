...
describe('helper wrappers', () => {
  const helperCases: Array<{
    ...
    {
      name: 'humanizeBytesDecimal',
      helper: humanizeBytesDecimal,
      options: { units: SI, postfix: 'B' },
      value: 8_388_608,
    },
    {
      name: 'humanizeBytesBinary',
      helper: humanizeBytesBinary,
      options: { units: Binary, postfix: 'B' },
      value: 1_048_576,
    },
    { name: 'humanizeStorage', helper: humanizeStorage, options: { units: SI, postfix: 'B' }, value: 2_500 },
    {
      name: 'humanizeStorageBinary',
      helper: humanizeStorageBinary,
      options: { units: Binary, postfix: 'B' },
      value: 1_024,
    },
    ...
    {
      name: 'humanizeAcceleration',
      helper: humanizeAcceleration,
      options: { units: SI, postfix: 'm/s^2' },
      value: 9.81,
    },
    ...
    {
      name: 'humanizeTemperatureKelvin',
      helper: humanizeTemperatureKelvin,
      options: { units: SI, postfix: '°K' },
      value: 12,
    },
    ...
    {
      name: 'humanizeCapacitance',
      helper: humanizeCapacitance,
      options: { units: SI, postfix: 'F' },
      value: 0.0000022,
    },
    ...
    {
      name: 'humanizeVolumeFlowRate',
      helper: humanizeVolumeFlowRate,
      options: { units: SI, postfix: 'm^3/s' },
      value: 0.0025,
    },
    {
      name: 'humanizeMassFlowRate',
      helper: humanizeMassFlowRate,
      options: { units: SI, postfix: 'kg/s' },
      value: 0.0025,
    },
    { name: 'humanizeDensity', helper: humanizeDensity, options: { units: SI, postfix: 'kg/m^3' }, value: 7_800 },
    {
      name: 'humanizeConcentration',
      helper: humanizeConcentration,
      options: { units: SI, postfix: 'mol/m^3' },
      value: 1.2,
    },
    { name: 'humanizeMolarMass', helper: humanizeMolarMass, options: { units: SI, postfix: 'g/mol' }, value: 0.012 },
    {
      name: 'humanizeMolarVolume',
      helper: humanizeMolarVolume,
      options: { units: SI, postfix: 'm^3/mol' },
      value: 0.00045,
    },
    {
      name: 'humanizeMolarDensity',
      helper: humanizeMolarDensity,
      options: { units: SI, postfix: 'mol/m^3' },
      value: 0.0000032,
    },
    {
      name: 'humanizeMolarConcentration',
      helper: humanizeMolarConcentration,
      options: { units: SI, postfix: 'mol/m^3' },
      value: 0.0009,
    },
    {
      name: 'humanizeMagneticFlux',
      helper: humanizeMagneticFlux,
      options: { units: SI, postfix: 'Wb' },
      value: 0.0042,
    },
    {
    ...
    {
      name: 'humanizeRadioactivity',
      helper: humanizeRadioactivity,
      options: { units: SI, postfix: 'Bq' },
      value: 3_200_000,
    },
    {
